        ...
        <div className="flex flex-col md:flex-row justify-between space-y-3 md:space-y-0">
          ...
          <div className="flex space-x-3">
            <Button
              ...
              className="flex-1 md:flex-none bg-gray-700 hover:bg-gray-600 text-white px-6 py-3 rounded-full font-medium transition duration-200 flex items-center justify-center h-auto"
            >
            ...
            <Button
              onClick={handleShare}
              className="flex-1 md:flex-none bg-[#1DB954] hover:bg-opacity-80 text-white px-6 py-3 rounded-full font-medium transition duration-200 flex items-center justify-center h-auto"
            >
